...
public class IAPManager : MonoBehaviour, IStoreListener
{
    ...
    public  string COINS_100 = "coin_100";
    public  string REMOVE_ADS = "com.polymathgames.onetapracer.removeads";
   ...
   void Awake()
    ...
    public PurchaseProcessingResult ProcessPurchase(PurchaseEventArgs args)
    {
        ...
        if (String.Equals(args.purchasedProduct.definition.id, COINS_100, StringComparison.Ordinal))
        {
            ...
            //IAPUIManager.instance.AddCoins(100);
        ...
        else if (String.Equals(args.purchasedProduct.definition.id, REMOVE_ADS, StringComparison.Ordinal))
        {
            ...
            if(IAPUIManager.instance)
                IAPUIManager.instance.RemoveAdsComplete();
        }
